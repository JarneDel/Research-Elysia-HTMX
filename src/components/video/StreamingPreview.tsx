export const StreamingPreview = () => (
  <>
    ...
    <div
      class="fixed z-10 resize-y overflow-auto border  aspect-video  rounded-box max-w-[1280px] max-h-[740px] min-w-64 min-h-36 bg-base-100 hidden right-8 bottom-8"
      id="stream-container"
